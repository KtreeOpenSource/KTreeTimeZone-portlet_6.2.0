...
/**
 * The persistence utility for the world clock service. This utility wraps {@link WorldClockPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see WorldClockPersistenceImpl
 * @generated
 */
public class WorldClockUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(WorldClock worldClock) {
		getPersistence().clearCache(worldClock);
	}
	 ...
	 */
	public static List<WorldClock> findWithDynamicQuery(
	 ...
	 */
	public static WorldClock update(WorldClock worldClock)
		throws SystemException {
		return getPersistence().update(worldClock);
	}
	...
	public static WorldClock update(WorldClock worldClock,
		...
		return getPersistence().update(worldClock, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(worldClock);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<com.ktree.timezone.model.dao.model.WorldClock> worldClocks) {
		getPersistence().cacheResult(worldClocks);
	}
	...
	*/
	public static com.ktree.timezone.model.dao.model.WorldClock create(int id) {
	...
	*/
	public static com.ktree.timezone.model.dao.model.WorldClock remove(int id)
		throws com.ktree.timezone.model.dao.NoSuchWorldClockException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(id);
	}

	public static com.ktree.timezone.model.dao.model.WorldClock updateImpl(
		com.ktree.timezone.model.dao.model.WorldClock worldClock)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(worldClock);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ktree.timezone.model.dao.model.WorldClock findByPrimaryKey(
		int id)
		throws com.ktree.timezone.model.dao.NoSuchWorldClockException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ktree.timezone.model.dao.model.WorldClock fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ktree.timezone.model.dao.model.WorldClock> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static WorldClockPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (WorldClockPersistence)PortletBeanLocatorUtil.locate(com.ktree.timezone.model.dao.service.ClpSerializer.getServletContextName(),
					WorldClockPersistence.class.getName());

			ReferenceRegistry.registerReference(WorldClockUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(WorldClockPersistence persistence) {
	}

	private static WorldClockPersistence _persistence;
}